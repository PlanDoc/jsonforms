...
import { JsonFormsFilterRegistryEntry } from "./filter";
import { JsonFormsDefaultsRegistryEntry } from "./defaults";
...
export declare const getFilter: (state: JsonFormsState) => JsonFormsFilterRegistryEntry;
export declare const getDefaults: (state: JsonFormsState) => JsonFormsDefaultsRegistryEntry;
